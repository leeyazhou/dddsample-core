...
import se.citerus.dddsample.domain.model.voyage.vo.Schedule;
...
public class SampleVoyages {
	...
	private static Voyage createVoyage(String id, Location from, Location to) {
		return new Voyage(new VoyageNumber(id),
				new Schedule(Collections.singletonList(new CarrierMovement(from, to, new Date(), new Date()))));
	}
	...
	public final static Voyage v100 = new Voyage.Builder(new VoyageNumber("V100"), HONGKONG)
			...
			.addMovement(NEWYORK, toDate("2009-03-06"), toDate("2009-03-09")).build();
	...
	public final static Voyage v300 = new Voyage.Builder(new VoyageNumber("V300"), TOKYO)
			...
			.addMovement(TOKYO, toDate("2009-03-19"), toDate("2009-03-21")).build();
	...
	public static final Voyage DALLAS_TO_HELSINKI_ALT = new Voyage.Builder(new VoyageNumber("0301S"), DALLAS)
			.addMovement(HELSINKI, toDate("2008-10-29", "03:30"), toDate("2008-11-05", "15:45")).build();
