 ...
 * unloaded from a carrier at some location at a given time.
 * <p/>
 ...
 * {@link se.citerus.dddsample.domain.model.cargo.vo.TrackingId},
 * {@link se.citerus.dddsample.domain.model.location.entity.Location}, timestamp
 * of the completion of the event, and possibly, if applicable a
 * {@link se.citerus.dddsample.domain.model.voyage.entity.Voyage}.
 * <p/>
...
public final class HandlingEvent implements DomainEvent<HandlingEvent> {
	...
	public HandlingEvent(final Cargo cargo, final Date completionTime, final Date registrationTime, final Type type,
			final Location location, final Voyage voyage) {
	...
	public String toString() {
		final StringBuilder builder = new StringBuilder("\n--- Handling event ---\n").append("Cargo: ")
				.append(cargo.trackingId()).append("\n").append("Type: ").append(type).append("\n").append("Location: ")
				.append(location.name()).append("\n").append("Completed on: ").append(completionTime).append("\n")
